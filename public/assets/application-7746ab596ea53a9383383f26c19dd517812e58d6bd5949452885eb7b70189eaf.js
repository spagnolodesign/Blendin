		...
		setupTemplates: function() {
			...
			var templates = {
				...
				'item': function(data, escape) {
					return '<div class="item chip-sm">' + escape(data[field_label]) + '</div>';
				},
