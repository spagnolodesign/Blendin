...
class Card extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  ...
  constructor(props) {
    ...
    // const w = this.refs.card.offsetWidth
    // const h = this.refs.card.offsetHeight
    // console.log(w,h)
    Object.defineProperty(this, "onMouseMove", {
      enumerable: true,
      writable: true,
      value: e => {
        let mouseX = e.pageX - this.refs.card.offsetLeft - e.target.offsetWidth / 2;
        let mouseY = e.pageY - this.refs.card.offsetTop - e.target.offsetHeight / 2;
        this.setState({
          mouseX: mouseX,
          mouseY: mouseY,
  ...
  cardBgTransform() {
    const tX = this.state.mouseX * -40;
    const tY = this.state.mouseY * -40;
    return {
  ...
  render() {
    const { name, avatar, about } = this.props;
    const rX = this.mousePX() * 10;
    const rY = this.mousePY() * -10;
    const tX = this.mousePX() * -15;
    const tY = this.mousePY() * -15;
    const styleCard = {
      transform: `rotateY(${rX}deg) rotateX(${rY}deg) rotateZ(1deg)`
    };
    const styleBG = {
      transform: `translateX(${tX}px) translateY(${tY}px)`,
      backgroundImage: `url(${avatar})`
    };
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { ref: "card", className: "CardWrap", onMouseMove: this.onMouseMove, onMouseLeave: this.onMouseLeave }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "Card", style: styleCard }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "CardBg", style: styleBG }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "CardInfo flex items-end" }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1", null, name))));
  }
}
...
/******/ });
//# sourceMappingURL=Card-04ae2e0e32e707520983.js.map